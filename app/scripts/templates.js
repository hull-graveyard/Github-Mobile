...
this["Hull"]["templates"]["app/dashboard"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program2(depth0,data,depth1) {
  ...
  stack2 = ((stack1 = helpers.ifEqual || depth0.ifEqual),stack1 ? stack1.call(depth0, depth0.name, depth1.currentView, options) : helperMissing.call(depth0, "ifEqual", depth0.name, depth1.currentView, options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += ">\n        <a href=\"#/dashboard/";
...
this["Hull"]["templates"]["app/repos"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, self=this, helperMissing=helpers.helperMissing, functionType="function", escapeExpression=this.escapeExpression, blockHelperMissing=helpers.blockHelperMissing;
...
function program2(depth0,data,depth1) {
  ...
  buffer += ">\n        <a href=\"#/repos/"
    ...
    + "/"
    + escapeExpression(((stack1 = depth1.repo),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "/";
  if (stack2 = helpers.name) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.name; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
...
function program5(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n  <div class=\"content repo-content\" data-hull-widget=\"";
  if (stack1 = helpers.currentView) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.currentView; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" data-hull-login=\"";
...
this["Hull"]["templates"]["blanket/blanket"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
this["Hull"]["templates"]["code/code"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n  <b><a class=\"homepage\" href=\""
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.homepage)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\" target=\"repo\">"
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.homepage)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</a></b>\n  ";
  return buffer;
  ...
  buffer += "<div class=\"inset-text\">\n  <header class=\"clearfix\">\n    <a class=\"button\" data-event=\"watch.toggle\" data-action=\"unwatch\" data-repo=\""
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.full_name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">\n      <span class=\"icon-eye-blocked\"></span> Watch\n    </a>\n    <a class=\"button\" data-event=\"watch.toggle\" data-action=\"unwatch\" data-repo=\""
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.full_name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">\n      <span class=\"icon-eye-blocked\"></span> Star\n    </a>\n    <a class=\"button\" data-event=\"watch.toggle\" data-action=\"unwatch\" data-repo=\""
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.full_name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">\n      <span class=\"icon-fork\"></span> Fork\n    </a>\n  </header>\n  <p>"
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.description)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</p>\n  ";
  stack2 = helpers['if'].call(depth0, ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.homepage), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n</div>\n\n<div class=\"code-house\">\n  <header data-event=\"repo.toggleContent\">\n    <span class=\"icon-file\"></span>\n    "
    + escapeExpression(((stack1 = ((stack1 = depth0.readme),stack1 == null || stack1 === false ? stack1 : stack1.name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\n    <span class=\"pull-right\">[+]</span>\n  </header>\n  <div class=\"code-house-inner\">\n    ";
  if (stack2 = helpers.readme_content) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.readme_content; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
    + "\n  </div>\n</div>\n\n<div class=\"margin\">";
  if (stack2 = helpers.name) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.name; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
    + "</b> /</div>\n<div class=\"file-list\" data-hull-widget='tree' data-hull-repo='"
    + escapeExpression(((stack1 = ((stack1 = depth0.repo),stack1 == null || stack1 === false ? stack1 : stack1.full_name)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "'>\n</div>\n";
  return buffer;
  };

this["Hull"]["templates"]["githull/githull"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
this["Hull"]["templates"]["profile/profile"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n          ";
  stack2 = helpers['if'].call(depth0, depth0.blog_url, {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
...
function program6(depth0,data) {
  ...
  if (stack1 = helpers.blog_url) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.blog_url; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">";
...
this["Hull"]["templates"]["repo_issues/issues"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, options, functionType="function", escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing, self=this, blockHelperMissing=helpers.blockHelperMissing;
...
function program2(depth0,data,depth1) {
  ...
  options = {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data};
  if (stack1 = helpers.issues) { stack1 = stack1.call(depth0, options); }
  else { stack1 = depth0.issues; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  if (!helpers.issues) { stack1 = blockHelperMissing.call(depth0, stack1, options); }
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</ul>\n";
  return buffer;
  };

this["Hull"]["templates"]["repos/repos"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, options, functionType="function", escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing, self=this, blockHelperMissing=helpers.blockHelperMissing;
...
this["Hull"]["templates"]["shelf/shelf"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression;


  buffer += "\n<div class=\"snap-drawer snap-drawer-left\">\n  <ul>\n    <li><input type=\"search\" placeholder=\"Search\" id=\"search\"></li>\n    <li class=\"sep\"></li>\n    <li>\n      <a href=\"#/dashboard/activity\">Dashboard</a>\n    </li>\n    <li>\n      <a href=\"#/users/"
    + escapeExpression(((stack1 = ((stack1 = depth0.githubAccount),stack1 == null || stack1 === false ? stack1 : stack1.login)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">My Profile</a>\n    </li>\n    <li>\n      <a href=\"https://github.com/hull/Github-Mobile\" target=\"_blank\">Fork me on Github</a>\n    </li>\n    <li class=\"sep\"></li>\n    <li>\n      <a data-hull-action='logout'>Logout</a>\n    </li>\n  </ul>\n  <span class=\"icon-github gh-logo\"></span>\n</div>\n";
  return buffer;
  };

this["Hull"]["templates"]["stars/stars"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
this["Hull"]["templates"]["tree/files"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<h3>Files...</h3>\n";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.json || depth0.json),stack1 ? stack1.call(depth0, depth0.files, options) : helperMissing.call(depth0, "json", depth0.files, options)));
  return buffer;
  };

this["Hull"]["templates"]["user_issues/issues"] = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", stack1, options, functionType="function", escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing, self=this, blockHelperMissing=helpers.blockHelperMissing;
